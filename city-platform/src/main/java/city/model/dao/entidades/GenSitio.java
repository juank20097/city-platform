...
public class GenSitio implements Serializable {
	...
	//bi-directional many-to-one association to IntSitiosCcaaDepartamento
	@OneToMany(mappedBy="genSitio")
	private List<IntSitiosCcaaDepartamento> intSitiosCcaaDepartamentos;
	...
	public List<IntSitiosCcaaDepartamento> getIntSitiosCcaaDepartamentos() {
		return this.intSitiosCcaaDepartamentos;
	}

	public void setIntSitiosCcaaDepartamentos(List<IntSitiosCcaaDepartamento> intSitiosCcaaDepartamentos) {
		this.intSitiosCcaaDepartamentos = intSitiosCcaaDepartamentos;
	}

	public IntSitiosCcaaDepartamento addIntSitiosCcaaDepartamento(IntSitiosCcaaDepartamento intSitiosCcaaDepartamento) {
		getIntSitiosCcaaDepartamentos().add(intSitiosCcaaDepartamento);
		intSitiosCcaaDepartamento.setGenSitio(this);

		return intSitiosCcaaDepartamento;
	}

	public IntSitiosCcaaDepartamento removeIntSitiosCcaaDepartamento(IntSitiosCcaaDepartamento intSitiosCcaaDepartamento) {
		getIntSitiosCcaaDepartamentos().remove(intSitiosCcaaDepartamento);
		intSitiosCcaaDepartamento.setGenSitio(null);
