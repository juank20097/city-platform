...
public class ManagerReporteZonas {
	...
	public ArrayList<DatosReporteTree> getAllElementosZonas() {
		...
		String sql = "SELECT gen_zonas.zon_id, gen_zonas.zon_nombre, gen_zonas.zon_descripcion,"
				...
				+ " (SELECT ite_nombre FROM gen_catalogo_items_det WHERE "
				+ " cat_codigo = 'cat_tipo_elemento' AND ite_codigo = gen_elementos_zona.elz_tipo) AS elz_tipo," 
				+ "(SELECT ite_nombre FROM gen_catalogo_items_det "
				+ " WHERE  cat_codigo = 'cat_unidades_medida' AND ite_codigo = elz_unidad_medida  ) "
				+ "AS elz_unidad_medida,"
	...
	public ArrayList<DatosReporteTree> getAllDatosVecindarios() {
		...
		String sql = "SELECT gen_zonas.zon_id, gen_zonas.zon_nombre, gen_zonas.zon_descripcion, gen_zonas.zon_hectareas,"
				...
				+ " (SELECT ite_nombre FROM gen_catalogo_items_det WHERE "
				+ " cat_codigo = 'cat_tipo_elemento' AND ite_codigo = gen_elementos_barrio.elb_tipo) AS elb_tipo,"
				+ " (SELECT ite_nombre FROM gen_catalogo_items_det "
				+ " WHERE  cat_codigo = 'cat_unidades_medida' AND ite_codigo = gen_elementos_barrio.elb_unidad_medida  ) AS elb_unidad_medida,"
				+ " gen_elemento_barrio_valor.ebv_valor"
				+ " FROM gen_zonas"
