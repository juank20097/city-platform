...
public class SeguridadBean {
	...
	public boolean validarCampos() {
		if ((getSegAccion() == null || getSegAccion().isEmpty())
				...
				|| (getUtmX().isEmpty() || getUtmY().isEmpty()) 
			...
			if (getSegLatitud() == 0 || getSegLongitud() == 0){
				String r = obtenerCoordenadas(getUtmX(),getUtmY());
				String [] parts= r.split(" ");
				setSegLatitud(Double.parseDouble(parts[0].trim()));
				setSegLongitud(Double.parseDouble(parts[1].trim()));
			}
			return false;
		}
	...
	private String obtenerCoordenadas(String utm_x,String utm_y) {
		String coordenada="";
		coordenada=Funciones.UTM2Deg("17 N "+utm_x+" "+utm_y+"");
		return coordenada;
	}
