...
create table GEN_SALUD (
   ...
   SLD_CONSUME_TABACO   VARCHAR(100)         null,
   SLD_CONSUME_ALCOHOL  VARCHAR(100)         null,
   SLD_MEDICAMENTOS     VARCHAR(254)         null,
...
create table SEG_REGISTRO_EMERGENCIAS (
   ...
   SEG_LATITUD          DECIMAL              null,
   SEG_LONGITUD         DECIMAL              null,
