...
/* Created on:     27/9/2016 16:13:44                           */
/*==============================================================*/


drop table GEN_AREAS;

drop table GEN_ASIGNACION_SUELO;
...
drop table GEN_HISTORIAL_SEGUIMIENTO;
...
drop table SEG_INCIDENCIAS_ADMIN;
...
/*==============================================================*/
/* Table: GEN_ASIGNACION_SUELO                                  */
/*==============================================================*/
create table GEN_ASIGNACION_SUELO (
   SUE_ID               INT4                 not null,
   ZON_ID               VARCHAR(100)         null,
   SUE_ACTIVIDAD        VARCHAR(254)         null,
   SUE_ASIGNACION       VARCHAR(100)         null,
   SUE_METROS           NUMERIC              null,
   SUE_FECHA_INICIO     DATE                 null,
   SUE_FECHA_FIN        DATE                 null,
   SUE_ESTADO           CHAR                 null,
   SUE_OBSERVACION      VARCHAR(254)         null,
   SUE_ARCHIVO          VARCHAR(254)         null,
   SUE_TIPO             VARCHAR(50)          null,
   constraint PK_GEN_ASIGNACION_SUELO primary key (SUE_ID)
);
...
/*==============================================================*/
/* Table: GEN_HISTORIAL_SEGUIMIENTO                             */
/*==============================================================*/
create table GEN_HISTORIAL_SEGUIMIENTO (
   SUE_ID               INT4                 not null,
   HSE_ID               INT4                 not null,
   ...
   constraint PK_GEN_HISTORIAL_SEGUIMIENTO primary key (SUE_ID, HSE_ID)
);
...
create table SEG_REGISTRO_EMERGENCIAS (
   ...
   SEG_UTM_X            VARCHAR(20)          null,
   SEG_UTM_Y            VARCHAR(20)          null,
...
alter table GEN_ASIGNACION_SUELO
   add constraint FK_GEN_ASIG_REFERENCE_GEN_ZONA foreign key (ZON_ID)
...
alter table GEN_HISTORIAL_SEGUIMIENTO
   add constraint FK_GEN_HIST_REFERENCE_GEN_ASIG foreign key (SUE_ID)
      references GEN_ASIGNACION_SUELO (SUE_ID)
      on delete restrict on update restrict;
